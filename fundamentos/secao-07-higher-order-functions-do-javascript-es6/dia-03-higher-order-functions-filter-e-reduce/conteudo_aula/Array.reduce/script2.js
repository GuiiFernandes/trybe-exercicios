...
const results = (array) => array.map((obj) => ({ 
  name: obj.nome,
  materia: obj.materias.reduce((bestMateria, materia) =>
    materia.nota >= bestMateria.nota ? materia : bestMateria).name,
}));
console.log(results(estudantes));