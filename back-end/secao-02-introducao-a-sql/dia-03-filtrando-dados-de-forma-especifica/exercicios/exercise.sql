-- Active: 1692040520117@@127.0.0.1@3306@store
USE store;
...
SELECT COUNT(*) empresas_com_f_no_id FROM suppliers WHERE id LIKE '%F%';
...
SELECT * FROM supplies WHERE price BETWEEN 16 AND 39 ORDER BY price;
-- Ufa! Por fim, faça uma query para exibir o número de vendas (sales) feitas entre os dias 15/04/2018 e 30/07/2019.
SELECT COUNT(*) vendas_entre_15_04_2018_e_30_07_2019 FROM sales WHERE order_date BETWEEN '2018-04-15' AND '2019-07-30';